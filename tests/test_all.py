...
# def test_seqsdist_lev() -> None:
#     s1 = ['AN',  'diesem',  'fünften',  'Stucke',  'des',  'puchs',  'Soll',
#           'wir',  'sagen',  'von']
#     s2 = ['An',  'diesem',  'fünften',  'Stück',  'des',  'Buchs',  'sollen',
#           'wir',  'sagen',  '']
#     dists = normeval.eval.seqsdist(s1, s2, 'lev')
#     assert dists == [1,0,0,2,0,1,3,0,0,3]


# ev = normeval.Evaluator(pred, gold)
# ev._get_and_enter_stats([1,2,3],{}, "foo")
